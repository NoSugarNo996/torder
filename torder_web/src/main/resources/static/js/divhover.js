...
(function($){
	$.fn.num = function(options){
		...
		function num1(){
			...
			function num2(){
				// top边框
				var divTop = "<div style='"+becurr+"height:2px;width:150px;top:-2px;left:-180px;' class='divTop'></div";
	
				// right边框
				var divRight = "<div style='"+becurr+"height:150px;width:2px;top:-180px;right:-2px;' class='divRight'></div";
	
				// Bottom边框
				var divBottom = "<div style='"+becurr+"height:2px;width:150px;bottom:-2px;right:-180px;' class='divBottom'></div";
	
				// Left边框
				var divLeft = "<div style='"+becurr+"height:150px;width:2px;bottom:-180px;left:-2px;' class='divLeft'></div";
				_this.hover(function(){
					el = $(this)
					el.append(divTop,divRight,divBottom,divLeft);
					num2 = new than(el)
